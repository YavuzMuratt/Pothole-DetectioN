...
# Open serial port for GPS data (adjust the port name as needed)
serial_port = 'COM10'  # Replace with your correct COM port
baud_rate = 9600
...
# Function to get current location from the GPS module
